      ...
      <div style={styles.content}>
        ...
        <div style={styles.card}>
          <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: 16, alignItems: "center" }}>
            {/* Placeholder QR (no lib esterne) */}
            <div style={styles.qrBox}>
              <div style={{ opacity: .6, fontSize: 12 }}>QR Code</div>
            </div>
        ...
        {/* Aggiungi amici rapidamente */}
        <div style={styles.card}>
          <div style={styles.label}>Add your friends</div>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
            <Link href={`/gruppo/${id}`} style={styles.btnPrimary}>
              Done
            </Link>
            <Link href={`/gruppo/${id}/stats`} style={styles.btnSecondary}>
              View stats
            </Link>
          </div>
        </div>
...
const styles: { [k: string]: React.CSSProperties } = {
  ...
  header: {
    ...
    padding: "16px 24px", backgroundColor: "#fff", boxShadow: "0 4px 6px rgba(0,0,0,.1)"
  },
  ...
  qrBox: {
    width: 120, height: 120, borderRadius: 12, border: "1px dashed #cbd5e1",
  ...
  friendChip: {
    background: "#fff7d6", border: "1px solid #f4e4a1", borderRadius: 10, padding: "8px 12px",
